			...
			array(
				...
				'content'		=> join(
					...
					array(
						...
						'<!-- /wp:heading -->',
						'<!-- wp:html -->',
						'<div id="lectures-timeline" class="bitad-timeline">',
						'<div class="bitad-timeline-scroll">',
						'</div>',
						'<script src="' . get_theme_file_uri() . '/assets/js/timeline.js?ver=0.0.1"></script>',
						'</div>',
						'<!-- /wp:html --></div></div>',
						'<!-- /wp:group -->',
						'<!-- wp:group -->',
						...
						'<!-- /wp:columns -->',
						'<!-- wp:paragraph {"align":"center"} -->',
						'<p class="has-text-align-center"><a href="' . get_site_url() . '/rejestracja">Dowiedz się więcej</a></p>',
						'<!-- /wp:paragraph --></div></div>',
						'<!-- /wp:group -->',
						...
						'<!-- wp:column {"verticalAlignment":"center"} -->',
						'<div class="wp-block-column is-vertically-aligned-center"><!-- wp:paragraph {"align":"left"} -->',
						'<p class="has-text-align-left">10:00-11:00</p>',
						'<!-- /wp:paragraph --></div>',
						'<!-- /wp:column --></div>',
						'<!-- /wp:columns -->',
						'<!-- wp:paragraph {"style":{"typography":{"fontSize":18}}} -->',
						...
						'<!-- wp:column {"verticalAlignment":"center"} -->',
						'<div class="wp-block-column is-vertically-aligned-center"><!-- wp:paragraph {"align":"left"} -->',
						'<p class="has-text-align-left">10:00-12:00</p>',
						'<!-- /wp:paragraph --></div>',
						'<!-- /wp:column --></div>',
						'<!-- /wp:columns -->',
						'<!-- wp:paragraph {"style":{"typography":{"fontSize":18}}} -->',
						...
						'<!-- wp:column {"verticalAlignment":"center"} -->',
						'<div class="wp-block-column is-vertically-aligned-center"><!-- wp:paragraph {"align":"left"} -->',
						'<p class="has-text-align-left">13:00-13:30</p>',
						'<!-- /wp:paragraph --></div>',
						'<!-- /wp:column --></div>',
						'<!-- /wp:columns -->',
						'<!-- wp:paragraph {"style":{"typography":{"fontSize":18}}} -->',
